...
sysName = 'TF-Boll-Omni2_1R' #System Name here
initCapital = 500000
commission = 100
#----------------------------------------------------------------------------------
...
#-----------
            ...
            if newMonth:
                marketVal1[curMarket] = marketMonitorList[curMarket].equity.cumuClsEquity
                cond1[curMarket] = True
            canTrade = cond1[curMarket]
            if cond1[curMarket] == True:
                marketVal2[curMarket]= marketMonitorList[curMarket].equity.cumuClsEquity
            if marketVal2[curMarket] < marketVal1[curMarket]- 2000:
                canTrade = False
 #               print(myDate[curBar]," ",mySymbol," canTrade = False ",marketVal2[curMarket]," ",marketVal1[curMarket])
            cond1[curMarket] = canTrade
