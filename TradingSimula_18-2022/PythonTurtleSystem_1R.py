...
sysName = 'PythonTurt_1R' #System Name here
initCapital = 1000000
commission = 0
anyLossIsALoser = False
#----------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------
#  Real trading start here with exit technology first
#  Long Exit Sys1
