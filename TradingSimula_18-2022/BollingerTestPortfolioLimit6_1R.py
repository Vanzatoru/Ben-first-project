...
sysName = 'Boll-10KLimit6Pos' #System Name here
initCapital = 500000
commission = 100
#----------------------------------------------------------------------------------
...
#-----------
            yesterdayPortPositions = 0
            if len(positionMatrix.posMatrixSize) > numMarkets:
                yesterdayPortPositions = getPortPositions (positionMatrix.posMatrixSize[-numMarkets:])
            totalPortPositions = yesterdayPortPositions + portTradesToday
...
#  Okay  Let's put in some logic to create a long position
            if crosses(myHigh,buyLevel,1,curBar-1) and mp !=1 and totalPortPositions < 6:
                price = myOpen[curBar]
                tradeName = "SimpleBuy"
                if mp == 0 : portTradesToday +=1
                numShares = posSize
...
#  Okay  Let's put in some logic to create a short position
            if crosses(myLow,shortLevel,-1,curBar-1) and mp !=-1 and totalPortPositions < 6 :
                price = myOpen[curBar]
