...
class systemMarkTrackerClass(object):
    ...
    def setSysMarkTrackingInfo(self,entryName,cumuProfit,mp,barsSinceEntry,barsSinceExit,curShares,trades):
 ...
 #       self.entryQuant = entryQuant
    ...
    def setSysMarkTrackingInfoB(self,barsSinceEntry,barsSinceExit,curShares,equItm,ote):
 #       self.entryPrice = entryPrice
 #       self.entryQuant = entryQuant
        self.curShares = curShares
        self.barsSinceEntry = barsSinceEntry
    ...
    def getSysMarkTrackingInfo(self):
        return(self.entryPrice,self.entryQuant,self.curShares,self.cumuProfit,self.barsSinceEntry,self.barsSinceExit)
