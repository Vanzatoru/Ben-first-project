...
sysName = 'TF-Boll-ATRNORM_1R' #System Name here
initCapital = 500000
commission = 25
#----------------------------------------------------------------------------------
...
#region intiation of lists and variables for testing enging
...
#----------X----------------------------------------------------------------------------------------
            ...
            marketVal1[curMarket] = sAverage(myRange,20,curBar,1)*myBPV

            if firstMarketLoop == False and curMarket == 0:
                maxNotValue = 0
                for mkt in range(0,numMarkets):
                    maxNotValue = max(maxNotValue,marketVal1[mkt])
            if firstMarketLoop == False:
                if marketVal1[curMarket] > 0 :
                    posSize = maxNotValue/(marketVal1[curMarket])
                posSize = int(posSize)
