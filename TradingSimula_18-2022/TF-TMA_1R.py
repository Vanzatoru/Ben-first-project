...
sysName = 'TF-TMA_1R' #System Name here
initCapital = 100000
commission = 50
#----------------------------------------------------------------------------------
...
#-----------
            sma = sAverage(myClose,19,curBar,1)
            ima = sAverage(myClose,49,curBar,1)
            lma = sAverage(myClose,199,curBar,1)

            posSize = 1

#  Long Entry
#  Okay  Let's put in some logic to create a long position
            if sma > ima and sma > lma and ima > lma and mp !=1:
                price = myOpen[curBar]
                tradeName = "TF-TMA-B"
                numShares = posSize
...
#  Long Exit 1
            if mp == 1 and sma < ima and barsSinceEntry > 1:
                price = myOpen[curBar]
                tradeName = "Lxit"
                numShares = curShares
