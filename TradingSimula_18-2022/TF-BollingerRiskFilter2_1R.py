...
sysName = 'TF-Boll-RiskFilt2_1R' #System Name here
initCapital = 500000
commission = 50
#----------------------------------------------------------------------------------
...
#  Okay  Let's put in some logic to create a long position
            if myHigh[curBar] >= buyLevel and mp !=1 and ATR*myBPV <= 1000:
...
#  Okay  Let's put in some logic to create a short position
            if myLow[curBar] <= shortLevel and mp !=-1 and ATR*myBPV <= 1000:
