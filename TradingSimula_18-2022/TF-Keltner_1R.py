...
sysName = 'TF-Keltner_1R' #System Name here
initCapital = 100000
commission = 50
#----------------------------------------------------------------------------------
...
#-----------
            keltUpChan,keltDnChan,keltMid = keltnerChannels(myDate,myOHLCTR,60,2,curBar,1)
            buyLevel   = roundToNearestTick(keltUpChan,1,myMinMove)
            shortLevel = roundToNearestTick(keltDnChan,-1,myMinMove)
            longExit   = roundToNearestTick(keltMid,-1,myMinMove)
            shortExit  = roundToNearestTick(keltMid,1,myMinMove)
            sum1 = sum2 = 0
            posSize = 1
