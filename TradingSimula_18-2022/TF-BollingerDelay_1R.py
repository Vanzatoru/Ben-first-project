...
sysName = 'TF-Bollinger_Delay_1R' #System Name here
initCapital = 100000
commission = 50
#----------------------------------------------------------------------------------
...
#-----------
            ...
            cm = curMarket
            if myClose[curBar-1] > upBand1: marketVal1[cm] +=1
            if myClose[curBar-1] <= upBand1: marketVal1[cm] = 0

            if myClose[curBar-1] < dnBand1: marketVal2[cm] +=1
            if myClose[curBar-1] >= dnBand1: marketVal2[cm]  = 0

         #   print(myDate[curBar]," ",marketVal1[cm]," ",marketVal2[cm]," ",myClose[curBar]," ",upBand1," ",dnBand1)
